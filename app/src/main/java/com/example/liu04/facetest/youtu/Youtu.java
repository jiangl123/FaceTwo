package com.example.liu04.facetest.youtu;
...
import com.example.liu04.facetest.youtu.sign.Base64Util;
import com.example.liu04.facetest.youtu.sign.YoutuSign;
...
//		connection.setRequestProperty("Host", "youtu.api.qcloud.com");
    ...
    */
    ...
    public JSONObject FaceIdentify(Bitmap bitmap, String group_id)
        ...
        JSONObject respose = SendRequest(data, "api/multifaceidentify");
 ...
 * @param group_id 人脸face组
 */
    public JSONObject FaceIdentifyServer(byte[] image, String group_id)
            throws IOException, JSONException, KeyManagementException, NoSuchAlgorithmException {
        JSONObject data = new JSONObject();
        String imageData = Base64Util.encode(image);
        data.put("image", imageData);
        data.put("group_id", group_id);
        JSONObject respose = SendRequest(data, "api/multifaceidentify");
        return respose;
    ...
    * @param group_ids 加入的group列表
   */
    public JSONObject NewPersonWithTag(Bitmap bitmap, String person_id,String tag,
                                List<String> group_ids) throws IOException, JSONException, KeyManagementException, NoSuchAlgorithmException {
        ...
        Log.e("NewPerson", "personId = " + person_id + "\ngroup_ids= = " + group_ids.toString() + "\nimage = " + imageData);
        JSONObject respose = SendRequest(data, "api/newperson");
    ...
    */
     ...
     * @throws Exception
     */
    public JSONObject GestureRecognize(Bitmap bitmap) throws Exception {
        JSONObject data = new JSONObject();
        String imageData = bitmapToBase64(bitmap);
        data.put("image", imageData);
        JSONObject respose = SendRequest(data, "handtracking/classify");
        return respose;
    }
